...
function Navbar() {
  ...
  return (
    <>
      ...
      {/* MOBILE MENU */}
     {menu && (
 <div className="md:hidden fixed top-16 left-0 right-0 bg-black bg-opacity-95 text-white py-6 shadow-lg z-40 overflow-hidden">
    <ul className="flex flex-col items-center gap-6 text-lg">
      {navItems.map(({ id, text, label }) => (
        <li key={id} className="hover:text-purple-300 duration-200 cursor-pointer">
          <Link
