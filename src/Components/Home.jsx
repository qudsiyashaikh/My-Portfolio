    ...
    <>
      ...
      >
        ...
        <div className="flex justify-center gap-6 mt-10">
          <a
            href="/Qudsiya Shaikh Python intern .pdf"
            download

            className="bg-purple-600 text-white px-4 py-3 rounded-xl text-base font-medium shadow-lg hover:bg-purple-700 transition"
          ...
          <a
            ...
            className="border-2 border-purple-500 text-purple-300 px-4
             py-3 rounded-xl text-base font-medium hover:bg-purple-600 hover:text-white transition"
